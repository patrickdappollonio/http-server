...
func run() error {
	...
	flags.StringVarP(&server.Path, "path", "d", "./", "The path you want to serve")
	flags.StringVar(&server.PathPrefix, "pathprefix", "/", "The path prefix for the URL where the server will listen on")
